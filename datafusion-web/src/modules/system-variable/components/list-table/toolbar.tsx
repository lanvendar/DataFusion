...
import { PageActionEnum, type VariablePageOption } from "../../dto";
import { VariableFilters } from "./filters";

interface ListToolbarProps {
  filter: VariablePageOption;
  onFilterChange: (value: VariablePageOption) => void;
  onSearch: () => void;
  onReset: () => void;
...
export function ListToolbar({ filter, onFilterChange, onSearch, onReset, onAction }: ListToolbarProps) {
  return (
    <div className="table-toolbar">
      <VariableFilters value={filter} onChange={onFilterChange} onSearch={onSearch} />
      <Space>
