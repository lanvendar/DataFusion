...
import com.datafusion.plugin.flink.schema.paimon.runtime.FlinkRuntimeConfigurer;
import com.datafusion.plugin.flink.schema.paimon.sink.PaimonMultiTableSinkFunction;
import com.datafusion.plugin.flink.schema.paimon.source.KafkaRecord;
import com.datafusion.plugin.flink.schema.paimon.source.KafkaSourceFactory;
import org.apache.flink.api.common.eventtime.WatermarkStrategy;
import org.apache.flink.connector.kafka.source.KafkaSource;
import org.apache.flink.streaming.api.environment.StreamExecutionEnvironment;

/**
 * flink-schema-paimon 插件启动入口.
 *
 * @author DataFusion
 * @version 1.0.0
 * @since 1.0.0
 */
public class FlinkSchemaPaimonApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlinkSchemaPaimonJobConfig config = loader.load(configPath);
