...
public class KafkaSourceFactory {
    ...
    private OffsetsInitializer startingOffsets(KafkaSourceConfig source) {
        ...
        throw new FlinkSchemaPaimonException("Unsupported source.startingOffsets: " + source.startingOffsets);
    }
    ...
    private long startingTimestampMs(KafkaSourceConfig source) {
        ...
        if (TextUtils.isBlank(value)) {
            throw new FlinkSchemaPaimonException("source.properties.starting.timestamp.ms is required for timestamp offsets");
        }
