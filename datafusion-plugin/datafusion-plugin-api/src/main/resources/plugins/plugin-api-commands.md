...
java -jar datafusion-plugin/datafusion-plugin-api/target/datafusion-plugin-api-1.0.0-executable.jar \
  --config datafusion-plugin/datafusion-plugin-api/src/main/resources/ods_hqpl_product_info-paimon-job.json
```
...
```bash
java -jar datafusion-plugin/datafusion-plugin-api/target/datafusion-plugin-api-1.0.0-executable.jar \
  --config datafusion-plugin/datafusion-plugin-api/src/main/resources/ods_hqpl_product_benchmark_price-paimon-job.json
```
