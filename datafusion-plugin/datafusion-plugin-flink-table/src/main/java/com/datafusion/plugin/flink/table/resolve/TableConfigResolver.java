...
class TableConfigResolver {
    ...
    String resolveTableName(FlinkTableJobConfig.PaimonTableConfig table) {
    ...
    PaimonTableConfig resolve(Object messageObject, FlinkTableJobConfig.PaimonTableConfig table, StandardSchema schema, String tableName) {
    ...
    private List<String> resolvePrimaryKeys(Object messageObject, PrimaryKeyConfig primaryKey, PaimonTableConfig config) {
        ...
        throw new FlinkTableException("Unsupported primaryKeys.mode: " + primaryKey.mode);
    }
