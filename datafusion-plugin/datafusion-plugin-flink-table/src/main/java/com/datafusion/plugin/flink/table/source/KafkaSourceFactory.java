...
public class KafkaSourceFactory {
    ...
    private OffsetsInitializer startingOffsets(KafkaSourceConfig source) {
        ...
        throw new FlinkTableException("Unsupported source.startingOffsets: " + source.startingOffsets);
    }
    ...
    private long startingTimestampMs(KafkaSourceConfig source) {
        ...
        if (TextUtils.isBlank(value)) {
            throw new FlinkTableException("source.properties.starting.timestamp.ms is required for timestamp offsets");
        }
