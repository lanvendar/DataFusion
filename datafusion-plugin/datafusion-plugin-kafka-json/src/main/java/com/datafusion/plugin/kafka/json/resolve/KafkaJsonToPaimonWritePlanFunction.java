 ...
 * @since 1.0.0
 */
public class KafkaJsonToPaimonWritePlanFunction extends RichFlatMapFunction<KafkaRecord, ResolvedTableWritePlan> {
     ...
     * 日志对象.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaJsonToPaimonWritePlanFunction.class);
     ...
     * @param sink sink 配置
     */
    public KafkaJsonToPaimonWritePlanFunction(PaimonSinkConfig sink) {
        this.sink = sink;
    }
