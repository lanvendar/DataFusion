 ...
 */
@SqlRepository
@SqlGet(sqlKey = "postgres")
public interface PostgresMapper extends SqlMapper<PostgresTableColumn> {
    ...
    List<PostgresTableColumn> getMetaData(@SqlDs DataSourceInfo ds, @SqlParam("schemaInfo") String schemaInfo);
