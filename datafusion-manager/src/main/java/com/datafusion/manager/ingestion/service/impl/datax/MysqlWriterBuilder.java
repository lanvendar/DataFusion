 ...
 * mysqlwriter builder.
 *
 * <p>DataX doc: https://github.com/alibaba/DataX/blob/master/mysqlwriter/doc/mysqlwriter.md
 ...
 */
@Component
public class MysqlWriterBuilder implements DataxWriterBuilder {
    ...
    public ObjectNode buildWriter(DataxJobContext ctx) {
        ...
        return DataxBuilderUtils.wrapNameAndParameter("mysqlwriter", parameter, om);
    }
}
