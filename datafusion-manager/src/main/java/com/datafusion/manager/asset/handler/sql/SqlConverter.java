...
public class SqlConverter {
    ...
    public static void main(String[] args) {
        String sql3 = "ALTER TABLE dw.table1 ATTACH PARTITION dw.p1 FOR VALUES IN ('day'); \n" +
                ...
                " sha " +
                "ALTER   TaBLE   dw.sebu1_ads_user_day_data_up_grid ATTACH   PARTITION dw.day_sebu1_ads_user_day_data_up_grid FOR VALUES IN ('day');\n";
        ...
        System.out.println("替换后 SQL: " + result);
    }
}