...
public class HologresType extends AbstractType {
    /**
     * 字段类型定义.
    ...
    protected void defineMappings(Map<DataType, Pair<String[], Boolean>> map) {
        ...
        // 字符文本
        map.put(DataType.CHAR, Pair.of(new String[] {"CHAR", "CHARACTER"}, true));
        ...
        //holo中,timestamptz因为都是国内的,可直接转化成TIMESTAMP,国际化的需要调整
        map.put(DataType.TIMESTAMP, Pair.of(new String[] {"TIMESTAMPTZ"}, true));
