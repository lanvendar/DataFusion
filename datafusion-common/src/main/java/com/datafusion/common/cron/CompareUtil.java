...
public class CompareUtil {
    ...
    /**
     * 利用Set列表去重,要求{@code <T>}必须实现hashCode和equals方法.
     *
     * @param list 去重目标集合
     * @param <T>  去重目标集合的泛型
     */
    ...
    /**
     * 比较大小,左边的必须比右边小,不满足抛出异常{@link IllegalArgumentException}.
     *
     * @param left  左边较小值
     * @param right 右边较大值
     */
    ...
    /**
     * 某个值是否在域的范围内,不满足抛出异常{@link IllegalArgumentException}.
     *
     * @param cronPosition 域的范围
     * @param value        值
     */
