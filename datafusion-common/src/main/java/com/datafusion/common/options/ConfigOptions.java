...
import com.datafusion.common.options.description.Description;
...
public class ConfigOptions {
    ...
    public static class TypedConfigOptionBuilder<T> {
        ...
        /**
         * The atomic type of the config option.
         */
        private final Class<T> clazz;
        
        /**
         * Creates a new builder for a config option.
         *
         * @param key   The key for the config option
         * @param clazz The atomic type of the config option
         */
