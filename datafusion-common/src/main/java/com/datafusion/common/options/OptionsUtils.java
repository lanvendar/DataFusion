...
import com.datafusion.common.utils.TimeUtils;
...
import static com.datafusion.common.options.StructuredOptionsSplitter.escapeWithSingleQuote;
...
public class OptionsUtils {
     ...
     * @return true if the config option can be represented as a prefix map.
     */
     ...
     * @param candidate The candidate config option key.
     * @return true if the candidate config option key is a prefix map key.
     */
    ...
    /**
     * Convert a map to a prefixed map.
     *
     * @param confData The map to convert.
     ...
     *
     * @param confData  The map to convert.
     * @param prefixKey The key to prefix.
     * @return The prefixed map.
     */
     ...
     * @param confData       The map to convert.
     * @param prefixKey      The key to prefix.
     * @param valuePredicate The predicate to filter the value.
     * @return The prefixed map.
     */
    public static Map<String, String> convertToPropertiesPrefixKey(
    ...
    /**
     * Check if a map contains a prefix map.
     *
     * @param confData The map to check.
     * @param key      The key to check.
     * @return true if the map contains a prefix map.
     */
     ...
     * Remove a prefix map.
     *
     * @param confData The map to remove.
