...
- “发布”保留为独立操作，点击后直接发布，不弹确认框，也不提供“同时开始调度”选项。
- “开始调度”统一打开调度配置弹框，触发器和调度窗口均必填。
- 没有历史调度配置时，窗口默认开始时间为今天 `00:00:00`，结束时间为一年后当天 `23:59:59`；已有配置时优先回填。
- 调度窗口按时长从短到长提供“当前时间”“今天(3月)”“今天(6月)”“今天(1年)”“今天(2年)”“今天(3年)”“今天(5年)”快捷项。
- “当前时间”以点击时的当前时分秒为开始时间，以当天 `23:59:59` 为结束时间。
- 手工选择调度窗口时，开始时间默认 `00:00:00`，结束时间默认 `23:59:59`。
